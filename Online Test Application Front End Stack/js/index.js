...
function checkAnswer() 
{
    ...
    {
        document.write("<body style='background-image: linear-gradient(to bottom right, #f511ff, #15d4df);'>");
        document.write("<div style='color:white;font-size:18pt;text-align:center;'>*****Your score is : "+correctCount+"*****</div>");
        document.write("</body>");
    }
